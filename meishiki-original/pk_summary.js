...
window.pkProSummaryHTML=function(p,inp){
  ...
  var H='<div class="card" style="border:2px solid var(--accent,#4E8060)">'
    ...
    +'<div style="background:#EAF4EE;border-radius:10px;padding:11px 12px"><div style="font-weight:800;color:#2E7D50;margin-bottom:5px">◎ 強み</div><ul style="margin:0;padding-left:1.15em;line-height:1.7;font-size:13.5px">'+r.strengths.map(function(x){return '<li style="margin:2px 0">'+esc(x)+'</li>';}).join('')+'</ul></div>'
    +'<div style="background:#FCEEE9;border-radius:10px;padding:11px 12px"><div style="font-weight:800;color:#B0483F;margin-bottom:5px">⚠ 辛口</div><ul style="margin:0;padding-left:1.15em;line-height:1.7;font-size:13.5px">'+r.cautions.map(function(x){return '<li style="margin:2px 0">'+esc(x)+'</li>';}).join('')+'</ul></div></div>'
