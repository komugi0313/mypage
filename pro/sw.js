/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v216';  /* 寿ゾーンの『ご縁が動きやすい年』に、天地徳合の年(巡る年運が命式と干合＋支合＝結婚・出産・良縁の最上級)と三合完成の年(年運で三合成立＝人生が大きく動く転機)を最優先で明示。天地徳合の年運検出はtokugoVs・三合完成はkaikyokuScanの既存ロジックを活用。※v215=親密な関係の傾向。 */
