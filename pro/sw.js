/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v140';  /* ①個人版から「天戦地冲（要注意の時期）」を②へ移植。日干支×年運・大運で判定（TENSENマップ＋既存のisChong/BR/年運/大運）。オンライン詳細鑑定・オフライン鑑定の両方に該当年・大運を反映。計算エンジン非改変。※v139＝宿命中殺の移植 */
