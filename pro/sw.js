/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v141';  /* ①個人版から「律音（りっちん・干支併臨＝干支が同じ柱／後天運で巡る時期）」を②へ移植。宿命律音・年運律音・大運律音を判定しオンライン/オフライン鑑定に反映。②のdecadeFortunesは立運後の大運のみ（月柱を含まない）点を考慮。①と290件で完全一致。計算エンジン非改変。※v140＝天戦地冲の移植 */
