/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v220';  /* 『あなたが伸びる環境（素材を活かす場所）』を命式ハイライトに追加：命式は良し悪しでなく素材で、強い通変グループ＋身強弱から活きる場を提示。魁罡・冲・異常干支を持つ人は環境の影響が強い（海の魚を山で育てない）と前向きに。実在人名なし。※v219=妬合ハイライト。 */
