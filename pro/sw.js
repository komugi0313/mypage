/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v226';  /* 知性・頭の良さのタイプを追加：偏印=天才型/印綬=理性派/傷官=感性型＋金(切れ味)・水(想像力)。偏印＋傷官＝繊細な天才/独自分野、印過多＋比劫食傷弱＝考えすぎ注意、水多＋火無＋冬＝知性が冷える等の注意と対策も。命式ハイライト＋詳細鑑定に。非断定・実在名なし。※v225=男性浮気。 */
