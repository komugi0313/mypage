/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v224';  /* 浮気しやすい傾向(前編)を追加：①火が強め=情熱/目移り②日主が水(壬癸)=モテる/流されやすい(金なしで強)④食傷大過=刺激/変化を好む を『関係が揺れやすい時期』の気質の傾向として前向き対策つきで。③壬丁の合はv217で既出。非断定・実在名なし。※v223=一途な命式。 */
