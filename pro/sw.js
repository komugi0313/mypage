/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v210';  /* 寿ゾーン（ことぶきゾーン）を追加：配偶者星(女=官星/男=財星)が巡る大運の最初の4年＝起承転結の恋愛開花期を大運・年運セクションに可視表示＋恋愛の自動鑑定に反映。配偶者星の位置→婚期傾向、干合＝運命的出会い/支合＝結婚/冲＝変化の年も。app-pro。※v209=宿命中殺拡充。 */
