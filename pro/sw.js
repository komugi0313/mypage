/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v202';  /* 日座中殺の意味に自己認識ポイントを追記：自由を守ろうとして逆に相手に合わせてもらう（コントロールする側になる）面もある→相手の自由も同じく尊重すると対等で長続き、と前向きに。app-pro＋meishi-sheet（＋①ミラー）。※v201=日座中殺の表示追加。 */
