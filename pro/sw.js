/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v223';  /* 恋愛エネルギーの向き先を追加：命式に異性の星(女=官星+財星/男=財星+食傷)が無いと、一途で安定・浮気の心配が少なく恋愛より自己研鑽・仕事へエネルギーが向くタイプとして前向きに命式ハイライトへ。比劫・印星中心なら一途さ際立つ／女性食傷強は自由優先も。非断定・実在名なし。※v222=恋愛のクセ。 */
