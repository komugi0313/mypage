/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v115';  /* オフライン鑑定を相談テーマ別に（恋愛/仕事/金運/人間関係/健康/引越/時期/全体）＝質問ごとに内容が変わり「同じ文章ばかり」を解消。オンライン鑑定のプロンプトに“わかりやすさ3原則”（用語は必ずその場で説明・一文を短く・読みがなを初出で統一）を追加 */
