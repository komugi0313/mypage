/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v240';  /* 印刷の中身を明確化：相性の印刷＝両者の名前＋相性鑑定書のみ（お互いの命式表は付けない）、個人の印刷＝本人名＋個人鑑定書。各結果の印刷ボタンはその結果の本文だけを印刷（相性ボタン→相性鑑定書／個人ボタン→個人鑑定書）。印刷ヘッダに氏名を明記。※v239=すべてリセット強調。 */
