/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v244';  /* 鑑定書の「過去の振り返り」を強化：pastKuboChongを拡張し空亡・冲・会局(三合/方合)の成立年を各直近3年まで検出。chartSummaryTextに【過去の振り返り】を渡し、鑑定書AIの章立てに独立小見出し「過去の振り返り（当たりの確認）」を追加＝過去に起きやすかったこと（変化・別れ・転職・転機）を問いかけ形で提示。meishi-sheet＋①個人版へバイトミラー。※v243=鑑定書に会局連携。 */
