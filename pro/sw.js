/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v208';  /* 十二運「絶」の意味に“ゾーンの正体”を追加：切り替え・リセットの星＝自我を手放しゾーン(究極の集中)に入れる才能／枠(目的・時間・一点集中)を決めると開花・なければ迷子。app-pro(TERR_FULL)＋meishi-sheet＋教科書juniun.html。実在人名なし。※v207=嘘が通用しにくい日柱。 */
