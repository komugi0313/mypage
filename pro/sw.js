/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v219';  /* 妬合（とごう＝ダブル干合）が命式にあるとき専用ハイライトを表示：一つの干合の縁に同じ干が割り込み競合（例:甲を2つの己が取り合う三角関係）＝恋愛の三角関係・仕事の横やり・一つを極めにくい面。ただし強い縁・変化のエネルギーで、狙いを絞れば味方にできると前向きに。年運の妬合はv217の揺れやすい時期で既出。※v218=干合冲の両面。 */
