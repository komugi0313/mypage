/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v194';  /* 教科書に「納音の相性」ページ(nayin-aisho.html)を追加：60干支を2つずつ束ねた30の納音（海中金〜大海水）、2人の日柱が同じ納音のとき成立する特別な相性（第一印象より話すほど通じ合う・志は同じ）、30納音の早見表（干支ペア・五行）、例題（己未×戊午＝天上火）付き。索引カード・SW登録。※v193=天戦地冲ページ追加。
...
const ASSETS = [
  ...
  'kanshi-aisho.html', 'aisho-pattern.html', 'daiun-tsuhen.html', 'setsuboku.html', 'tensen-chichu.html', 'nayin-aisho.html'
];
