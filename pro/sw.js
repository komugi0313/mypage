/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v145';  /* 生年月日の入力を「年・月・日」プルダウンに変更（本人・お相手とも）。端末の言語に関係なく必ず年→月→日の順で表示され、英語端末で日付が逆順（MM/DD/YYYY）に見える問題を解消。月ごとに日数を自動調整。隠しinputにYYYY-MM-DDを同期し既存処理はそのまま。※v144＝AI鑑定文の分量を充実 */
