/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v243';  /* 鑑定書AI(meishi-sheet)にも会局を連携：chartSummaryTextに命式表の会局（大運・年運の三合/方合/半会/半方＝2027年以降含む）を渡し、「運の流れ」章で三合・方合の巡る時期を必ず具体的に取り上げるよう指示。鑑定(app-pro)側は既に会局の成立時期を言語化済み。meishi-sheet＋①個人版へバイトミラー。※v242=命式表印刷の自動縮小フィット。 */
