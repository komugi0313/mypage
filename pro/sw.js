/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v237';  /* 鑑定結果に「🖨 印刷 / PDF保存」ボタンを直接追加（相性診断・相談・自動鑑定すべて）。従来は「保存→マイページ→開く→印刷」と遠く、相性の印刷が見つけにくかったのを、結果画面からワンタップで印刷/PDFできるように。app-proのみ。※v236=命式表の罫線太線化＋下端切れ対策。 */
