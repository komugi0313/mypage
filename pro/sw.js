/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v230';  /* 「自由に輝く“特別な命式”」判定を鑑定ハイライトに追加：水火偏り／印・食傷・比劫・官殺の大過／咸池複数→「型にはめる結婚より、束縛の少ない自由な形・表現・専門で才能が開花する自由型（結婚に不向きの意ではない）」と前向き表示。app-proのみ。※v229=白虎殺両面精緻化。 */
