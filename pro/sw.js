/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v201';  /* 日座中殺（日坐空亡・日柱が甲戌/乙亥）を命式表の吉凶星に自動表示＋意味を鑑定に出力。自分の世界と自由を大切にする星として前向きに（束縛の少ない関係が合う／自分の人生を楽しむ力）。app-pro.html＋meishi-sheet.html（＋①ミラー）。※v200=淫欲殺拡充。 */
