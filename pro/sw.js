/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v221';  /* 養生に『子宝・妊娠のしやすさ』を追加：水=腎(生命の源)のバランス（多め=冷え/控えめ=乾き）＋食傷(子の星)・土(子宮)・火(温め)から傾向と養生（温める/潤す食べ物）、水・食傷・財星が巡る時期を東洋医学の目安として。医療の断定はせず注記付き・実在人名なし。app-pro。※v220=伸びる環境。 */
