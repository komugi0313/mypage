/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v231';  /* 鑑定士がお客様に助言できるよう表示を精緻化：通変組み合わせ（倒食・傷官見官・財印交戦・劫財奪財等）でデータ側にあった「対策・助言(助)」を捨てずに必ず表示（意味→お客様への助言/活かし方）。三合・方合も「どの五行の分野が強まるか＋用神/忌神での活かし方」を明記。app-proのみ。※v230=自由型判定。 */
