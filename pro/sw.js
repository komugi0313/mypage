/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v217';  /* 『関係が揺れやすい・気をつけたい時期』（浮気予防のお守り）を追加：①壬丁の合が巡る年(化木で気持ちが育つ)②妬合/争合の年(一つの縁に割り込み)③乙丁辛の日主(承認欲求ケア)。大運・年運セクションに折りたたみ＋恋愛の自動鑑定に反映。予防的で前向き。実在人名・露骨表現なし。※v216=寿ゾーン天地徳合/三合。 */
