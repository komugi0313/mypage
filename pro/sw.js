/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v209';  /* 宿命中殺を拡充：⑤日居中殺(甲辰・乙巳)を追加、5種(生年/生月/生日/日座/日居)の特徴・開運ポイントを記事準拠に精緻化、命式ハイライトに宿命中殺カード（見落とし防止）＋成功の共通点5つ。日居中殺は命式表チップにも(app-pro/meishi-sheet)。※v208=絶ゾーン。 */
