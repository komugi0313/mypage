/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v227';  /* 気をつけたい運気の時期（お守り）を追加：命式×大運×年運で三刑(寅巳申・丑戌未)が成立する年、水火激冲(子午・巳亥の冲で水火が激突／水火とも強い命式)の年を、備えのカレンダーとして前向きに大運・年運セクションへ。白虎殺は対象干支の確認後に。非断定・実在名なし。※v226=知性タイプ。 */
