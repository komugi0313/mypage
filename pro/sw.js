/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v236';  /* 命式表(印刷)の罫線を全体的に太く・濃く：yk-tbl のセル枠1px→1.5px＋色を--rule(濃)に、表の外枠2.2pxを追加。命式(四柱)・大運とも一番下の閉じ線がくっきり。印刷時に表の一番下の線がプリンタ非印字域で切れないよう、命式表シートの下パディングを5mm→9mmに。meishi-sheet＋①個人版へバイトミラー。※v235=鑑定文の用語やさしい言い換え。 */
