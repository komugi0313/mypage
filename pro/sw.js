/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v117';  /* 鑑定の読みやすさ改善：先頭の色付き要約枠を“短い結論1行”に（重複した圏外注意書きを削除）、オンラインのリード文も80字以内に。「・」始まりの箇条書きが二重丸にならないよう整形を修正。※v116＝相性の質問もオフラインでテーマ別化／v115＝個人のオフラインをテーマ別化＋わかりやすさ3原則 */
