/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v118';  /* 鑑定カードの見た目調整：要約枠をセージ緑にして見出し（ピンク）と役割を分離、本文を14.5→15pxに拡大（読みやすさ向上・余白は現状維持）。※v117＝要約枠を短い結論に＋箇条書き整形修正／v116＝相性の質問もテーマ別化／v115＝個人のオフラインをテーマ別化＋わかりやすさ3原則 */
