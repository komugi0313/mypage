/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v198';  /* 淫欲殺（日柱ベース神殺）を追加：日柱が甲寅・乙卯・丁巳・己未・庚申・辛卯・戊戌・癸丑のとき命式表の吉凶星欄に自動表示＋意味を鑑定材料に。app-pro.html／meishi-sheet.html（＋①ミラー）に実装。計算エンジンは無改変。※v197=十二運の教科書ページ強化。 */
