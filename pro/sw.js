/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v228';  /* 白虎殺（日柱が甲辰・乙未・丙戌・丁丑・戊辰・壬戌・癸丑）を命式表の吉凶星に追加＝事故・病気・血・水難に備えを促す星。安全・健康を意識すれば凶意は薄れる“お守り”、仕事の力は大きいと前向きに。囚獄・血刃は実装済み・表と一致を確認。app-pro＋meishi-sheet（＋①ミラー）。※v227=三刑・水火激冲。 */
