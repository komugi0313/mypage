/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v144';  /* AI鑑定文の分量を充実：個人の質問回答 450-650字→700-900字、相性メイン 650-850字→850-1050字、相性の質問回答 500-700字→750-950字（実測でオンライン回答が個人1144字・相性1738字に増加）。※v143＝出身地をメイン欄へ等のUI整理 */
