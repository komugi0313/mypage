/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v215';  /* 親密な関係の傾向（大人向けの見方）を折りたたみで追加：四旺(子午卯酉)の情熱・卯酉の冲の二面性(抑圧と解放のギャップ/主導と受け身/ギャップ萌え/こだわり)を成熟した相性鑑定レベルで。露骨・グラフィックな表現と実在人名は不使用。大運・年運セクション。※v214=四旺/卯酉冲ハイライト。 */
