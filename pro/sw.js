/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v239';  /* 「すべてリセット」を目立つ赤系ボタン＋明確なラベル（本人・お相手・鑑定結果をまとめて消す）に。機能は既存resetMain（本人＋相性のお相手＋全結果を一括クリア）を流用＝ワンタップで全消去。相性の入力・結果が下に残る問題を解消。※v238=印刷ボタンを目立たせ。 */
