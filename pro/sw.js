/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v211';  /* 通変グループの才能・適職を“たとえ”で（比劫=ストライカー/食傷=ムードメーカー/財=縁の下の力持ち/官殺=クラス委員長/印=図書館の住人）。月柱＝仕事・適職の観点で鑑定データに追加＋教科書tsuhensei.htmlに『才能と適職』表を新設。app-pro。※v210=寿ゾーン。 */
