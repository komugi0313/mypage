/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v212';  /* 養生に『髪・頭皮の養生』を追加：髪=血の余り／水=うるおい・木=成長力、金多木弱・水少・木弱の傾向を判定し、木を補う(緑野菜・森林浴)・土を疏く(糖質控え)・黒い食べ物・ストレスケアを養生の目安として提示（医療ではない）。app-pro。※v211=通変たとえ。 */
