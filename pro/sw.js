/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v233';  /* 大運・年運の各行(展開パネル doukanUnsei)を厚く：干通変の起こりやすいこと＋過ごし方に加え、①支通変の「底流に」②その人の身強弱に照らした「あなたにとって＝追い風/守り」を具体助言付きで表示。鑑定士が「あなたは身弱だからこの時期はこう」と言える形に。app-proのみ。※v232=ハイライト助言一掃＋格局活かし方。 */
