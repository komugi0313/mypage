/* 四柱推命占い自動鑑定 — オフライン対応 Service Worker（経験者版ドメイン専用）
   ...
   オフライン鑑定に自動で切り替わる。 */
const CACHE = 'shichu-jidou-v142';  /* ①個人版から「モテ度・魅力タイプ」を②へ移植。①の式（桃花+2/紅艶+2/日柱沐浴+1/食傷2つ+1→★1〜5）を②純正データ（吉凶星pillarKichi・十二運・通変natalTs10）で算出しオンライン/オフライン鑑定に反映。咸池・沐浴・食傷は①と一致、紅艶は②純正（命式の星として判定・利用者判断）。計算エンジン非改変。※v141＝律音の移植 */
