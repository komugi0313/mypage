...
//   → Standard 50／Pro 100／VIP 175／無料はお試し合計15。
const LIMITS = {
  free:     { deep: 15,  total: 60,  ip: 120 },  // 無料お試し：本格鑑定 合計15（3日間・月間枠）＋雑談。獲得コストとして上限厳しめ
  standard: { deep: 50,  total: 400, ip: 500 },  // Standard $19.99：本格鑑定 50/月＋雑談・理屈（原価¥4/通でも利益率≥60%を保証）
  pro:      { deep: 100, total: 600, ip: 700 },  // Pro $39.99：本格鑑定 100/月＋雑談・理屈（同上）
  vip:      { deep: 175, total: 900, ip: 1000 }, // VIP $69.99：本格鑑定 175/月＋雑談・理屈（同上）
};
